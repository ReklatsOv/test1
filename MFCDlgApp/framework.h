// framework.h : стандартные файлы включения для проекта

#pragma once

#ifndef VC_EXTRALEAN
#define VC_EXTRALEAN            // Редко используемые компоненты исключаются из заголовочных файлов Windows
#endif
...
// отключает функцию MFC скрывать некоторые часто используемые, но часто игнорируемые предупреждения
